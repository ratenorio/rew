      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="texto3">
            ...
            <p><a class="btn btn-dark btn-button" href="#livros" role="button">Saber mais</a></p>
          </div>
        </div>
        <div class="col-lg-4">
          ...
          <div class="texto3">
            ...
            <p><a class="btn btn-dark btn-button" href="#rew" role="button">Saber mais</a></p>
          </div>
        </div>
        <div class="col-lg-4">
          ...
          <div class="texto3">
            ...
            <p><a class="btn btn-dark btn-button" href="#fanart" role="button">Saber mais</a></p>
          </div>
        </div>
      </div>
    </div>
